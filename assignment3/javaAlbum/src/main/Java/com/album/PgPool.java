...
//        Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    public static void main(String[] args) throws SQLException, IOException, ClassNotFoundException {
        String url = "jdbc:postgresql://localhost:5432/album?serverTimezone=Asia/Shanghai&amp;useUnicode=true&amp;characterEncoding=utf8";
        PgPool pgPool = PgPool.getInstance(url, "postgres", "postgres");
//        pgPool.save();
